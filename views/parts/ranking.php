...
<h2 class="text-2xl my-4">
    Classement
    <button class="ml-1 btn btn-ghost btn-circle" hx-get="/<?= $id ?>/ranking">
        <!-- https://fontawesome.com/icons/rotate -->
        <svg xmlns="http://www.w3.org/2000/svg" class="w-4" fill="currentcolor" viewBox="0 0 512 512">
...
<table class="table">
    ...
    <tbody>
        <?php foreach ($participants as $participant) : ?>
            <tr
                hx-delete="/<?= $id ?>/remove-participant/<?= $participant->user_id ?>"
